        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm leading-relaxed text-slate-400">
              The premier B2B marketplace connecting international buyers with
              verified Uzbek manufacturers across textiles, agriculture,
              minerals, and more.
            </p>
            {/* Social Links */}
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <FooterLink href="/companies">Manufacturers</FooterLink>
              <FooterLink href="/rfq">Request Quotes</FooterLink>
              <FooterLink href="/products?export=true">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <FooterLink href="/register">Join as Manufacturer</FooterLink>
      ...
      <div className="border-t border-slate-800">
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-3 px-4 py-6 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-sm text-slate-500">
            &copy; {new Date().getFullYear()} Made in Uzbekistan. All rights
            reserved.
          </p>
